package com.example.utilsdemo.kd_tree.demo1;// Illustrates n-nearest-neighbors method of KDTree class.  Creates a KDTree
...
class kdnbrs {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Integer[] nbrs = (Integer[]) kd.nearest(targ, n);
